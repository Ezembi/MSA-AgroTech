...
- Создайте новое ADR со ссылкой на основной вариант из Задания 4. Проработайте два-три варианта изоляции данных с критериями сравнения (изоляция на уровне схем БД, на уровне отдельных БД и на уровне инстансов).
- Представьте диаграммы C2 для каждого варианта.
